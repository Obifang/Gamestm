...
namespace PHPSolution
{
    public partial class mainform : Form
    {
        ...
        /*
           ...
           public bool validstockname(string stockname, object sender, EventArgs e)//out string errorMessage
           {
           ...
           public bool Validstockdesc(string stockdesc, object sender, EventArgs e)//out string errorMessage
           {
           ...
           public bool validstocktype(string stocktype, object sender, EventArgs e)//out string errorMessage
           {
           ...
           public bool validstockquantity(int stockquantity, object sender, EventArgs e)//out string errorMessage
           {
                if (stockquantity <= 0)
                {
                    MessageBox.Show("Please insert the quantity of stock item, cannot be a negative number");
           ...
           public bool validstockprice(decimal stockprice, object sender, EventArgs e)//out string errorMessage
           {
               if (stockprice <= 0)
               {
                   MessageBox.Show("Please insert the price of stock item, cannot be a negative number");
